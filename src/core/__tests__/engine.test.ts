...
// Reads the real demo input/expected files from demo/ and validates the engine
// produces an exact match.  The expected file was generated by running the
// cleaner on a real GitHub PR page copy-paste and reviewing the result.
